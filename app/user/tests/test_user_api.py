...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_for_user(self):
        """Test that the token was created for the user"""
        payload = {'email': 'test@test1', 'password': 'testpass'}
        create_user(**payload)
...
class PrivateUserAPITests(TestCase):
    """Test API requests resuire authentication"""
    ...
    def test_retrieve_profile_success(self):
        """Test retirieving profile for logged in used"""
        res = self.client.get(ME_URL)
